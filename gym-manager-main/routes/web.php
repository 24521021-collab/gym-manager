...
Route::middleware(['auth', 'CheckRole:admin'])->prefix('admin')->group(function () {
    ...
    Route::resource('packages', GymPackageController::class)->except(['create', 'show', 'edit']);
    //trang admin quản lý các lớp học 
    Route::resource('gym-classes', ClassController::class)->names('admin.gym-classes')->except(['create', 'show', 'edit']);
    //trang admin quản lý sản phẩm
    Route::resource('products', AdminProductController::class)->names('admin.products')->except(['create', 'show', 'edit']);
